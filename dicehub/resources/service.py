...
class ResourcesService:
    ...
    def get_by_key(self, *, namespace_id: str, path: str) -> Resource:
        result = self._graphql.execute(
    ...
    def get_text(self, *, resource_id: str) -> str:
        result = self._graphql.execute(
    ...
    def create_text(self, *, namespace_id: str, path: str, content: str) -> None:
    ...
    def set_text(self, *, resource_id: str, content: str) -> None:
        response = self._execute_mutation(
...
def _resource_from_payload(payload: ResourcePayload) -> Resource:
    ...
    try:
        ...
        pass
    if resource is None:
        raise ProtocolError("dicehub returned an invalid resource.")
    return resource
...
def _validated_response(
    ...
    try:
        ...
        pass
    if response is None:
        raise ProtocolError("dicehub returned an incompatible resource response.")
    return response
